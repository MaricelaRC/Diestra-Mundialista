  ...
  return (
    ...
    >
      <button
        ...
        className="w-full p-4 flex items-center justify-between gap-2 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
      >
        <div className="min-w-0">
          <h4 className="font-bold text-gray-900 text-[13px] tracking-tight leading-snug">
            {hotel.name}
          </h4>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <span className="text-[10px] bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full font-bold whitespace-nowrap text-center">
            {count} {label}
          </span>
          {expanded ? (
