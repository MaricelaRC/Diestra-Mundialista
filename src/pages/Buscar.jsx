...
export default function Buscar() {
  ...
  return (
    <div className="min-h-screen text-gray-900 font-sans px-2 md:px-0">
      <div className="max-w-md md:max-w-3xl lg:max-w-5xl mx-auto bg-white/85 md:bg-white backdrop-blur-md shadow-2xl border-x border-gray-200 min-h-screen flex flex-col">
